...
for polarity in range(2):
    ...
    sum_count+=count
count_combo+=sum_count

#reporting the read data:
print ("Total number of reveiws: "+str(sum_count))
...
history = rnn_simple_model.fit(x=padded_train_sequences, 
                    ...
                    verbose=1)
"""
best_rnn_simple_model = load_model('./models/rnn_no_embeddings/weights-improvement-06-0.8684.hdf5')
...
best_rnn_model_with_glove_embeddings = load_model('./models/rnn_with_embeddings/weights-improvement-02-0.8800.hdf5')
...
history = cnn_model_multi_channel.fit(x=padded_train_sequences, 
                    ...
                    verbose=1)
"""
best_cnn_model = load_model('./models/cnn_multi_channel/weights-improvement-09-0.8688.hdf5')
