...
#
# Dataset: Polarity dataset for Uzbek language that has been manually collected from top 100 Uzbek aaps at Google play Store
...
if __name__ == '__main__':
    ...
    review_counts = [count_reviews(data_dir, filenames[0]) , count_reviews(data_dir, filenames[1])]
    ...
    for polarity in range(2):
		...
		for line in infile.readlines():
		    ...
		    if count>(float(split_percentage)/100)*review_counts[polarity]:
			count_test+=1
